...
{{--                </div>--}}
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li><a href="{{route('painel.index')}}"><i class="fa fa-dashboard"></i> <span>Painel</span></a></li>
                    <li><a href="{{route('pessoas.index')}}"><i class="fa fa-group"></i> <span>Pessoas</span></a></li>
                    <li><a href="{{route('apartamentos.index')}}"><i class="fa fa-building"></i> <span>Apartamentos</span></a></li>
                    <li><a href="{{route('correspondencias.index')}}"><i class="fa fa-envelope"></i> <span>Correspondências</span></a></li>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2019-2020 <a href="https://adminlte.io">VetAdmin</a>.</strong> by @dev_matthaus
        </footer>
